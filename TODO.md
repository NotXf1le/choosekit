...
- Add an optional local MCP package for Claude Code, Codex, and OpenCode. Expose `choose` as a read-only stdio tool backed by a configured `llama.cpp` scorer, and keep MCP dependencies out of the core `choosekit` package.
